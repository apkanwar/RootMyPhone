...
public class AboutActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                AboutActivity.this.startActivity(new Intent(AboutActivity.this, MainActivity.class));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_device) {
            AboutActivity.this.startActivity(new Intent(AboutActivity.this, DeviceListActivity.class));
        }
            ...
            AboutActivity.this.startActivity(new Intent(AboutActivity.this, SettingsActivity.class));
        }
