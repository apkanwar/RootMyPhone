...
public class Zenfone2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_zenfone_2);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_zenfone2);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_zenfone2);
        ...
        header.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Zenfone2Activity.this.startActivity(new Intent(Zenfone2Activity.this, MainActivity.class));
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_device) {
            Zenfone2Activity.this.startActivity(new Intent(Zenfone2Activity.this, DeviceListActivity.class));
        }
            ...
            Zenfone2Activity.this.startActivity(new Intent(Zenfone2Activity.this, AboutActivity.class));
        }
        else if (id == R.id.nav_settings) {
            // Restarts settings activity when menu option is tapped
            Zenfone2Activity.this.startActivity(new Intent(Zenfone2Activity.this, SettingsActivity.class));
        }
