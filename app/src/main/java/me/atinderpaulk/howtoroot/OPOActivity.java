...
public class OPOActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_opo);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_opo);
        ...
        header.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OPOActivity.this.startActivity(new Intent(OPOActivity.this, MainActivity.class));
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_device) {
            OPOActivity.this.startActivity(new Intent(OPOActivity.this, DeviceListActivity.class));
        }
            ...
            OPOActivity.this.startActivity(new Intent(OPOActivity.this, AboutActivity.class));
        }
        else if (id == R.id.nav_settings) {
            // Restarts settings activity when menu option is tapped
            OPOActivity.this.startActivity(new Intent(OPOActivity.this, SettingsActivity.class));
        }
